...
const MOCK_MODELS: Model[] = [
  {
    ...
    status: 'online',
    bio: 'Finding the whisper of desire in the dark.'
  },
  {
    id: '2',
    name: 'Julianne',
    ...
    status: 'online',
    bio: 'Will you enter the room, or fear the desire?'
  },
  {
    id: '3',
    name: 'Elena',
  ...
  },
  {
    ...
    status: 'online',
    bio: 'The most beautiful desires grow in total darkness.'
  }
];
      ...
      <div className="mx-auto max-w-7xl">
        <div className="mb-20 flex flex-col justify-between gap-8 border-b border-white/10 pb-12 md:flex-row md:items-end">
          <div>
            ...
            <h2 className="mb-4 font-serif text-5xl leading-none text-white md:text-6xl">The <span className="italic text-red-200">Desire</span> Gallery.</h2>
            <p className="max-w-md font-light italic tracking-wide text-white/60">"Close your eyes and breathe... then open them to see what the desire reveals."</p>
          </div>
          <div className="flex flex-wrap gap-4">
            <a href={trackingLink} className="block rounded-sm border border-white/5 bg-white/10 px-8 py-3 text-center text-[9px] font-bold uppercase tracking-widest text-white transition-all hover:border-red-500/50 hover:bg-red-500/30">Hottest Rooms</a>
        ...
        <div className="mt-28 text-center">
          <a href={trackingLink} className="group mx-auto block flex flex-col items-center gap-6 text-center text-[10px] font-bold uppercase tracking-[0.6em] text-white/40 transition-all hover:text-red-500">
             <span className="mb-2 font-serif text-xs italic lowercase text-red-200 opacity-70 group-hover:opacity-100">more rooms await...</span>
